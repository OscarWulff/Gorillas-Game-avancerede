...
public class GameScreen {
    ...
    public void runThread() {
        ...
        if (player1.getTurn()) {
            ...
            for (int i = 0; i < curve.size(); i++) {
                bananaImg.setLayoutY(monkey1.getStart_y() - monkeyOneImg.getFitHeight() - curve.get(i));
            ...
            for (int i = 0; i < curve.size(); i++) { // this for-loop changes the location of the banana image
                bananaImg.setLayoutY(monkey2.getStart_y() - monkeyTwoImg.getFitHeight() - (curve.get(i)));
    ...
    public List<Integer> makeCurve(Banana banana) {
        ...
        while (banana.trajectory(x, airResistance) > - 1000
            ...
            this.curve.add(banana.trajectory(x, airResistance));
            x++;
        }
